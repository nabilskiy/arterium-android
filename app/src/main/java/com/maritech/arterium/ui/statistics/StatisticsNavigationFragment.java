...
import com.maritech.arterium.databinding.NavigationStatisticsBinding;
...
public class StatisticsNavigationFragment
        extends BaseFragment<NavigationStatisticsBinding> {

    @Override
    public int getLayoutRes() {
        return R.layout.navigation_statistics;
    }
