...
import com.maritech.arterium.databinding.NavigationProfileBinding;
...
public class ProfileNavigationFragment
        extends BaseFragment<NavigationProfileBinding> {

    @Override
    public int getLayoutRes() {
        return R.layout.navigation_profile;
    }
